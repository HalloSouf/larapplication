        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" style="min-width: 700px;">
                            @csrf

                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group c-login-form-group">
                                        <label class="c-login-label" for="firstname">Voornaam</label>
                                        <div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group c-login-form-group">
                                        <label class="c-login-label" for="lastname">Achternaam</label>
                                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group c-login-form-group">
                                        <label class="c-login-label" for="password-confirm">Bevestig wachtwoord</label>
                                        <div>
